...
function ProjectFrame({ className, theme, title, role, image }: Props) {
  ...
  return (
    <>  
            <div className={`p-0 flex flex-col border border-[6px] sm:border-[10px] rounded-[30px] w-[90vw] h-[30vh] lg:w-[50vw] sm:w-[90vw] md:w-[90vw] sm:h-[40vh] md:h-[40vh] lg:h-[50vh] border-[#ffffff7d] overflow-hidden ${className}`}>
